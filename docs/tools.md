...
<!-- output:src/org/moeaframework/analysis/tools/Negater.java [:-2] {help} -->
...
Converts the last record in a result file into the ARFF format for use by any compatible tools.
