...
public class QuarticExample implements UnivariateFunction {
	...
	public static void main(String[] args) {
		if (args.length == 0 || args[0].equalsIgnoreCase("program")) {
			SymbolicRegressionGUI.runDemo(new ProgramSymbolicRegression(new QuarticExample(), -1.0, 1.0, 100));
		} else if (args[0].equalsIgnoreCase("grammar")) {
			SymbolicRegressionGUI.runDemo(new GrammarSymbolicRegression(new QuarticExample(), -1.0, 1.0, 100));
		} else {
