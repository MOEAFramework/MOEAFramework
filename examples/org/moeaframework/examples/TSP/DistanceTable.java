...
public abstract class DistanceTable {
	...
	/**
	 * Returns the identifiers of all neighbors of the specified node.  A neighbor must have a direct edge between
	 * itself and the specified node.
	 * 
	 ...
	 * @throws IllegalArgumentException if there is no direct edge between the two nodes, or if no node exists with the
	...
	/**
	 * Returns {@code true} if the specified nodes are neighbors; {@code false} otherwise.
	 * 
	 * @param id1 the identifier of the first node
	 * @param id2 the identifier of the second node
