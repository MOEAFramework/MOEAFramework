...
\paragraph{Over 1000 test cases to ensure validity.}  Every release of the MOEA Framework undergoes extensive testing and quality control checks.  And, if any bugs are discovered that survive this testing, we will promptly fix the issues and release patches.  
...
\begin{description}
  ...
  \item[Disadvantages:]\ %force line break
    \begin{itemize}
      ...
      \item Focused on single-objective optimization, providing only outdated MOEAs (NSGA-II and SPEA2)
