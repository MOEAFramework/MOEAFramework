...
Running the downloaded demo application, either by double-clicking the JAR file or running the command \plaintext{java -jar MOEAFramework-%VERSION%-Demo.jar}, will launch a program to provides several interactive demos of the MOEA Framework.  This is intended for first-time users to quickly learn about the MOEA Framework and its capabilities.
