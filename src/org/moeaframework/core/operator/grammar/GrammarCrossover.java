...
public class GrammarCrossover extends TypeSafeCrossover<Grammar> {
	...
	/**
	 * Constructs a new grammar crossover operator with 100% probability of
	 * being applied to each solution.
	 */
	...
	/**
	 * Constructs a single-point crossover operator for grammars with the specified
