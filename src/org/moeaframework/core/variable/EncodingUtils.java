...
public class EncodingUtils {
     ...
     * @param lowerBound the lower bound of the floating-point value
     * @param upperBound the upper bound of the floating-point value
     * @param step       the step of the floating-point value
     * @return a new floating-point decision variable bounded within the
     * specified range and step
     */
    public static StepRealVariable newStepReal(double lowerBound, double upperBound, double step) {
        return new StepRealVariable(lowerBound, upperBound, step);
    }

    /**
     * Returns a new binary floating-point decision variable bounded within the
     * specified range and step.
     *
     * @param lowerBound the lower bound of the floating-point value
     * @param upperBound the upper bound of the floating-point value
     ...
     * specified range and step
     */
    public static BinaryRealStepVariable newBinaryStepReal(double lowerBound, double upperBound, double step) {
        return new BinaryRealStepVariable(lowerBound, upperBound, step);
    }
    ...
    public static double getReal(Variable variable) {
        ...
        } else if (variable instanceof StepRealVariable) {
            return ((StepRealVariable) variable).getValue();
        } else if (variable instanceof BinaryRealStepVariable) {
            return ((BinaryRealStepVariable) variable).getValue();
        } else {
    ...
    public static void setReal(Variable variable, double value) {
        if (variable instanceof RealVariable) {
            ...
            ((StepRealVariable) variable).setValue(value);
        } else {
            throw new IllegalArgumentException(NOT_REAL);
        }
    }
