...
/**
 * Fitness value attribute, typically computed by a fitness function.
 */
public final class Fitness implements Attribute {
	
	/**
	 * The name / key used for this attribute.
	 */
	public static final String ATTRIBUTE_NAME = "fitness";
