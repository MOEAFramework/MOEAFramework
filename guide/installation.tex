...
We encourage new users to read through our examples to learn more about the basic use of the MOEA Framework.  We also have a number of online resources.  The documentation page on our website at \webpage{moeaframework.org/documentation.html} provides access to the API Specification showing all available documentation for classes and methods.  In addition, you can find books available for purchase including the recommended Beginner's Guide to the MOEA Framework.  You can also visit our Github page at \webpage{https://github.com/MOEAFramework/MOEAFramework} to submit bug reports and help requests.
