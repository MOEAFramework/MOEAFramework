...
public class InvertedDTLZ1Test extends ProblemTest {
	...
	public void testProvider() {
		assertProblemDefined("Inverted_DTLZ1_2", 2);
		assertProblemDefined("Inverted_DTLZ1_3", 3);
	}
	...
	public void testReferenceSet() {
		testReferenceSet("Inverted_DTLZ1_2", InvertedDTLZ1Test::assertParetoFrontSolution);
		testReferenceSet("Inverted_DTLZ1_3", InvertedDTLZ1Test::assertParetoFrontSolution);
	}
