...
public class RastriginTest extends ProblemTest {
	...
	public void test() {		
		try (AbstractSingleObjectiveProblem problem = new Rastrigin()) {
			...
			Assert.assertEquals(57.84942745, MockSolution.of(problem).atLowerBounds().evaluate().getObjective(0), 0.0000001);
			Assert.assertEquals(57.84942745, MockSolution.of(problem).atUpperBounds().evaluate().getObjective(0), 0.0000001);
		}
	}
