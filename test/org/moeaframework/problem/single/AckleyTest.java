...
public class AckleyTest extends ProblemTest {
	...
	public void test() {		
		try (AbstractSingleObjectiveProblem problem = new Ackley()) {
			...
			Assert.assertEquals(19.96676885, MockSolution.of(problem).atLowerBounds().evaluate().getObjective(0), 0.0000001);
			Assert.assertEquals(19.96676885, MockSolution.of(problem).atUpperBounds().evaluate().getObjective(0), 0.0000001);
		}
	}
