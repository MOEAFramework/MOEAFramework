...
public class ZCAT11Test extends ProblemTest {
	...
	public void test() {
		...
		Assert.assertArrayEquals(new double[] { 2.724464, 8.027485, 20.207547 }, 
				evaluateAt(problem, 0.006726, 0.042860, 0.126059, -1.860593, -1.694467, 2.490285, 2.394761, 0.819671, -1.716377, 0.629490, -3.192200, 0.386490, -6.329432, -0.158435, -4.634449, 0.903844, -2.366734, 2.881049, -1.510300, 2.654129, 3.192454, -2.727939, -3.115215, 5.620439, 0.508911, -9.552645, 8.543997, 5.788566, -5.705426, 11.332616).getObjectiveValues(),
				0.0001);
	}
	
	@Test
	public void testGenerate() {
		assertGeneratedSolutionsAreNondominated(new ZCAT11(3), 1000);
	}
