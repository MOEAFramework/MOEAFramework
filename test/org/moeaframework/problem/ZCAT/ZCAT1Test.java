...
public class ZCAT1Test {
	...
	public void testProvider() {
		Assert.assertNotNull(ProblemFactory.getInstance().getProblem("ZCAT1_2"));
		Assert.assertNotNull(ProblemFactory.getInstance().getReferenceSet("ZCAT1_2"));
		Assert.assertEquals(2, ProblemFactory.getInstance().getProblem("ZCAT1_2").getNumberOfObjectives());
		
		Assert.assertNotNull(ProblemFactory.getInstance().getProblem("ZCAT1_3"));
		Assert.assertNull(ProblemFactory.getInstance().getReferenceSet("ZCAT1_3"));
		Assert.assertEquals(3, ProblemFactory.getInstance().getProblem("ZCAT1_3").getNumberOfObjectives());
	}
