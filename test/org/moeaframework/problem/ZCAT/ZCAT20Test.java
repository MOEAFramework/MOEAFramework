...
public class ZCAT20Test {
	...
	public void testProvider() {
		Assert.assertNotNull(ProblemFactory.getInstance().getProblem("ZCAT20_2"));
		Assert.assertNotNull(ProblemFactory.getInstance().getReferenceSet("ZCAT20_2"));
		Assert.assertEquals(2, ProblemFactory.getInstance().getProblem("ZCAT20_2").getNumberOfObjectives());
		
		Assert.assertNotNull(ProblemFactory.getInstance().getProblem("ZCAT20_3"));
		Assert.assertNull(ProblemFactory.getInstance().getReferenceSet("ZCAT20_3"));
		Assert.assertEquals(3, ProblemFactory.getInstance().getProblem("ZCAT20_3").getNumberOfObjectives());
	}
