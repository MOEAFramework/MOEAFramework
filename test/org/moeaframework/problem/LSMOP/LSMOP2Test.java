...
public class LSMOP2Test {
	...
	public void testProvider() {
		Assert.assertNotNull(ProblemFactory.getInstance().getProblem("LSMOP2_2"));
		Assert.assertNotNull(ProblemFactory.getInstance().getReferenceSet("LSMOP2_2"));
		Assert.assertEquals(2, ProblemFactory.getInstance().getProblem("LSMOP2_2").getNumberOfObjectives());
		
		Assert.assertNotNull(ProblemFactory.getInstance().getProblem("LSMOP2_3"));
		Assert.assertNull(ProblemFactory.getInstance().getReferenceSet("LSMOP2_3"));
		Assert.assertEquals(3, ProblemFactory.getInstance().getProblem("LSMOP2_3").getNumberOfObjectives());
	}
