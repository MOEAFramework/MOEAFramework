...
public class ResultFileSeedMergerTest extends AbstractToolTest {
	...
	public static final String MISMATCHED_RESULT_FILE = """
			# Problem = DTLZ2_2
			# Variables = 11
			# Objectives = 2
			//NFE=100
	...
	public void testMismatchedEntries() throws Exception {
		File resultFile1 = TempFiles.createFile().withContent(COMPLETE_RESULT_FILE);
		File resultFile2 = TempFiles.createFile().withContent(MISMATCHED_RESULT_FILE);
		File combinedFile = TempFiles.createFile();
