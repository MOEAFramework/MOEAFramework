...
public class LinearObjectiveComparatorTest {
	...
	public void testCalculate() {
		...
		Assert.assertEquals(calculate(MockSolution.of().withObjectives(-1.0, 0.0), weights), -1.0, TestEnvironment.LOW_PRECISION);
		Assert.assertEquals(calculate(MockSolution.of().withObjectives(0.0, -1.0), weights), -1.0, TestEnvironment.LOW_PRECISION);
		Assert.assertEquals(calculate(MockSolution.of().withObjectives(1.0, 1.0), weights), 2.0, TestEnvironment.LOW_PRECISION);
		Assert.assertEquals(calculate(MockSolution.of().withObjectives(1.0, -1.0), weights), 0.0, TestEnvironment.LOW_PRECISION);
