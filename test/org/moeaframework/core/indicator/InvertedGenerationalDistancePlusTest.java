...
public class InvertedGenerationalDistancePlusTest extends AbstractIndicatorTest<InvertedGenerationalDistancePlus> {
	
	@Override
	public InvertedGenerationalDistancePlus createInstance(Problem problem, NondominatedPopulation referenceSet) {
		return new InvertedGenerationalDistancePlus(problem, referenceSet);
	}
	...
	public void testIshibuchi() {
		Assert.assertEquals(3.55, IshibuchiTestInstances.computeIGDPlus(IshibuchiTestInstances.Example1RefSet,
				IshibuchiTestInstances.Example1SetA), TestThresholds.LOW_PRECISION);
		
		Assert.assertEquals(6.11, IshibuchiTestInstances.computeIGDPlus(IshibuchiTestInstances.Example1RefSet,
				IshibuchiTestInstances.Example1SetB), TestThresholds.LOW_PRECISION);
		
		Assert.assertEquals(3.55, IshibuchiTestInstances.computeIGDPlus(IshibuchiTestInstances.Example2RefSet,
				IshibuchiTestInstances.Example2SetA), TestThresholds.LOW_PRECISION);
		
		Assert.assertEquals(7.171, IshibuchiTestInstances.computeIGDPlus(IshibuchiTestInstances.Example2RefSet,
				IshibuchiTestInstances.Example2SetB), TestThresholds.LOW_PRECISION);
		
		Assert.assertEquals(1.707, IshibuchiTestInstances.computeIGDPlus(IshibuchiTestInstances.Example1RefSet,
				IshibuchiTestInstances.Example3SetD), TestThresholds.LOW_PRECISION);
		
		Assert.assertEquals(1.483, IshibuchiTestInstances.computeIGDPlus(IshibuchiTestInstances.Example4RefSet,
				IshibuchiTestInstances.Example4SetA), TestThresholds.LOW_PRECISION);
		
		Assert.assertEquals(2.260, IshibuchiTestInstances.computeIGDPlus(IshibuchiTestInstances.Example4RefSet,
				IshibuchiTestInstances.Example4SetB), TestThresholds.LOW_PRECISION);
		
		Assert.assertEquals(3.55, IshibuchiTestInstances.computeIGDPlus(IshibuchiTestInstances.Example5RefSet,
				IshibuchiTestInstances.Example5SetA), TestThresholds.LOW_PRECISION);
		
		Assert.assertEquals(4.854, IshibuchiTestInstances.computeIGDPlus(IshibuchiTestInstances.Example5RefSet,
				IshibuchiTestInstances.Example5SetB), TestThresholds.LOW_PRECISION);
		
		Assert.assertEquals(1.0, IshibuchiTestInstances.computeIGDPlus(IshibuchiTestInstances.Example6RefSet,
				IshibuchiTestInstances.Example6SetA), TestThresholds.LOW_PRECISION);
		
		Assert.assertEquals(2.236, IshibuchiTestInstances.computeIGDPlus(IshibuchiTestInstances.Example6RefSet,
				IshibuchiTestInstances.Example6SetB), TestThresholds.LOW_PRECISION);
		
		Assert.assertEquals(2.828, IshibuchiTestInstances.computeIGDPlus(IshibuchiTestInstances.Example8RefSet,
				IshibuchiTestInstances.Example8SetA), TestThresholds.LOW_PRECISION);
		
		Assert.assertEquals(5.0, IshibuchiTestInstances.computeIGDPlus(IshibuchiTestInstances.Example8RefSet,
				IshibuchiTestInstances.Example8SetB), TestThresholds.LOW_PRECISION);
		
		Assert.assertEquals(2.828, IshibuchiTestInstances.computeIGDPlus(IshibuchiTestInstances.Example9RefSet,
