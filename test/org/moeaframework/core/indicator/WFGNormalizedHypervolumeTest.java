 ...
 */
public class WFGNormalizedHypervolumeTest extends IndicatorTest {
	...
	public void testEmptyReferenceSet() {
		...
		WFGNormalizedHypervolume hypervolume = new WFGNormalizedHypervolume(problem, referenceSet);
	...
	public void test(WFGNormalizedHypervolume hypervolume) {
		NondominatedPopulation approximationSet = new NondominatedPopulation();
	...
	public void testExplicitBounds() {
		...
		WFGNormalizedHypervolume hypervolume = new WFGNormalizedHypervolume(problem,
				new double[] { 0.0, 0.0 },
				new double[] { 1.0, 1.0 });
	...
	public void test2(WFGNormalizedHypervolume hypervolume) {
		NondominatedPopulation approximationSet = new NondominatedPopulation();
	...
	public void testWellKnownSets() {
		...
		testWellKnownSet("DTLZ2_8", 0.6808146042);
	}
	
	public void testWellKnownSet(String problemName, double expectedHypervolume) {
